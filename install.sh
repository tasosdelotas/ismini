...
# No sudo needed. No Flatpak. No AppImage. Just Node.js + 2MB of code.
set -e
...
# Create desktop file inline (no external icon file needed)
DESKTOP_FILE="$HOME/.local/share/applications/ismini.desktop"
...
if [ -d "$HOME/Desktop" ]; then
  cp "$DESKTOP_FILE" "$HOME/Desktop/ismini.desktop"
...
echo ""
echo "Done! Start ismini with:"
echo "  $DIR/ismini"
echo ""
echo "Or open the web UI: http://127.0.0.1:8787"
